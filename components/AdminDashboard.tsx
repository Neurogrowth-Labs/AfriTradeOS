    ...
    <div className="h-full flex flex-col gap-6 animate-fade-in pb-6">
      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm flex justify-between items-center">
        ...
        <div className="flex gap-2">
           <button onClick={() => alert('System configuration panel coming soon.')} className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-200 rounded-lg text-sm font-bold hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors">
             <Settings className="w-4 h-4" /> Config
           </button>
           <button onClick={() => alert('Generating admin report...')} className="flex items-center gap-2 px-4 py-2 bg-trade-primary text-white rounded-lg text-sm font-bold hover:bg-trade-primary/90 transition-colors">
        ...
        {activeTab === 'kyc' && (
          <div className="space-y-4 animate-fade-in">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                 <button onClick={() => alert('Filter options coming soon.')} className="p-2 bg-gray-100 dark:bg-slate-700 rounded-lg hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors"><Filter className="w-4 h-4" /></button>
                 <button onClick={() => alert('Search functionality coming soon.')} className="p-2 bg-gray-100 dark:bg-slate-700 rounded-lg hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors"><Search className="w-4 h-4" /></button>
              </div>
            </div>
                           ...
                           <td className="p-4 text-right">
                              {req.status === 'Pending' && (
                                <div className="flex justify-end gap-2">
                                   ...
                                   <button onClick={() => alert('Viewing KYC details...')} className="p-1.5 bg-gray-50 text-gray-600 rounded hover:bg-gray-100 border border-gray-200" title="View Details">
        ...
        {activeTab === 'aml' && (
           <div className="space-y-4 animate-fade-in">
              <div className="flex justify-between items-center">
                ...
                <button onClick={() => { if(confirm('Are you sure you want to pause all trades globally?')) alert('Global trade pause activated.'); }} className="text-sm text-red-600 font-bold hover:underline flex items-center gap-1">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {alert.status === 'Open' && (
                                <div className="flex gap-2">
                                    ...
                                    <button onClick={() => window.alert('Trade frozen pending investigation.')} className="px-3 py-1.5 bg-red-600 text-white rounded text-sm font-bold hover:bg-red-700 shadow-sm flex items-center gap-1">
