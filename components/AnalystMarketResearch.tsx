...
const COUNTRY_PROFILES: CountryProfile[] = [
  {
    ...
    gdp: '$477B',
    population: '223M',
    topImports: ['Refined Petroleum', 'Wheat', 'Vehicles', 'Plastics'],
    topExports: ['Crude Oil', 'Cocoa', 'Rubber', 'Cashew Nuts'],
    tradeBalance: '-$12.4B',
    afcftaStatus: 'Ratified',
    riskLevel: 'Medium',
    ease: 62,
    consumption: '$340B',
    bloc: 'ECOWAS',
  },
  {
    ...
    gdp: '$113B',
    population: '54M',
    topImports: ['Petroleum', 'Iron/Steel', 'Machinery', 'Vehicles'],
    topExports: ['Tea', 'Coffee', 'Cut Flowers', 'Vegetables'],
    tradeBalance: '-$9.8B',
    afcftaStatus: 'Ratified',
    riskLevel: 'Low',
    ease: 73,
  ...
  },
  {
    ...
    gdp: '$77B',
    population: '33M',
    topImports: ['Vehicles', 'Rice', 'Cement', 'Machinery'],
    topExports: ['Gold', 'Cocoa', 'Oil', 'Manganese'],
    tradeBalance: '+$2.1B',
    afcftaStatus: 'Ratified (HQ)',
    riskLevel: 'Low',
    ease: 78,
    consumption: '$65B',
    bloc: 'ECOWAS',
  },
  {
    ...
    gdp: '$399B',
    population: '60M',
    topImports: ['Petroleum', 'Machinery', 'Electronics', 'Vehicles'],
    topExports: ['Gold', 'Platinum', 'Iron Ore', 'Vehicles'],
    tradeBalance: '+$5.6B',
    afcftaStatus: 'Ratified',
    riskLevel: 'Medium',
    ease: 84,
  ...
  },
  {
    ...
    gdp: '$476B',
    population: '104M',
    topImports: ['Wheat', 'Petroleum', 'Iron/Steel', 'Machinery'],
    topExports: ['Petroleum', 'Textiles', 'Chemicals', 'Citrus'],
    tradeBalance: '-$18.2B',
    afcftaStatus: 'Ratified',
    riskLevel: 'Medium',
    ease: 71,
  ...
  },
  {
    ...
    gdp: '$156B',
    population: '120M',
    topImports: ['Petroleum', 'Machinery', 'Vehicles', 'Cereals'],
    topExports: ['Coffee', 'Oilseeds', 'Gold', 'Flowers'],
    tradeBalance: '-$11.8B',
    afcftaStatus: 'Ratified',
    riskLevel: 'High',
    ease: 48,
...
const HS_PRODUCTS: HSProduct[] = [
  {
    code: '0901.11',
    name: 'Coffee (not roasted)',
    volume: '$2.8B',
    trend: '+8%',
    topMarkets: ['EU', 'USA', 'Japan'],
    tariffRate: '12%',
    afcftaRate: '0%',
  },
  {
    ...
    volume: '$4.1B',
    trend: '+15%',
    topMarkets: ['Netherlands', 'USA', 'Germany'],
    tariffRate: '10%',
    afcftaRate: '0%',
  },
  {
    ...
    volume: '$1.2B',
    trend: '+22%',
    topMarkets: ['Netherlands', 'UK', 'Germany'],
    tariffRate: '8%',
    afcftaRate: '2%',
  },
  {
    ...
    volume: '$0.8B',
    trend: '+18%',
    topMarkets: ['Nigeria', 'Ghana', 'Tanzania'],
    tariffRate: '20%',
    afcftaRate: '5%',
  },
  {
    code: '1006.30',
    name: 'Rice (semi/wholly milled)',
    volume: '$3.2B',
    trend: '+5%',
    topMarkets: ['Nigeria', 'Senegal', 'Ghana'],
    tariffRate: '25%',
    afcftaRate: '10%',
  },
  {
    ...
    volume: '$6.4B',
    trend: '+12%',
    topMarkets: ['UAE', 'Switzerland', 'India'],
    tariffRate: '5%',
    afcftaRate: '0%',
  },
];
...
export const AnalystMarketResearch: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    'profiles' | 'hsCode' | 'competitors' | 'opportunities'
  >('profiles');
  ...
  const generateSummary = async (country: CountryProfile) => {
    ...
    try {
      ...
      setAiReport(
        `${country.name}: GDP ${country.gdp}, population ${country.population}. ${country.afcftaStatus}. Key risk: ${country.riskLevel}.`
      );
    } finally {
      setAiLoading(false);
    }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 dark:text-gray-400">
                Country profiles • HS Code intelligence • Competitor analysis • AI opportunity
                finder
              </p>
            </div>
          </div>
          <form onSubmit={handleSearch} className="relative w-full md:w-96">
            ...
            >
              {loading ? (
                ...
                <>
                  <ArrowRight className="w-3 h-3" /> Search
                </>
              )}
            </button>
          </form>
        ...
        <div className="flex-1 flex flex-col gap-4 min-h-0 overflow-y-auto">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 p-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-blue-800 dark:text-blue-300">
                  Comparing {compareList.length}/3 countries
                </span>
                <div className="flex gap-1">
                  {comparedCountries.map(c => (
                    <span
                      key={c.id}
                      className="text-[10px] bg-blue-100 dark:bg-blue-800 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full font-bold"
                    >
                      {c.flag} {c.name}
                    </span>
                  ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadarChart data={RADAR_DATA}>
                      ...
                      <Radar
                        name={comparedCountries[0]?.name || 'A'}
                        dataKey="A"
                        stroke="#3b82f6"
                        fill="#3b82f6"
                        fillOpacity={0.2}
                ...
                <div className="space-y-2">
                  {comparedCountries.map((c, _i) => (
                    <div
                      key={c.id}
                      className="p-3 rounded-lg border border-gray-100 dark:border-slate-700"
                    >
                      ...
                      <div className="grid grid-cols-3 gap-2 text-center">
                        <div>
                          <p className="text-xs font-black text-trade-primary dark:text-white">
                            {c.gdp}
                          </p>
                        ...
                        <div>
                          ...
                          <p className="text-[9px] text-gray-400">Ease Score</p>
                        </div>
                      </div>
                    </div>
                  ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {COUNTRY_PROFILES.map(country => (
              <div
                key={country.id}
                className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-4 hover:shadow-lg transition-all group"
              >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-gray-400">
                        {country.bloc} • {country.afcftaStatus}
                      </span>
                    </div>
                  </div>
                  <button
                    ...
                    className={`p-1.5 rounded-lg text-[10px] font-bold transition-colors ${
                      compareList.includes(country.id)
                        ? 'bg-blue-100 text-blue-600'
                        : 'bg-gray-100 dark:bg-slate-700 text-gray-400 hover:text-blue-500'
                    }`}
                  >
                    {compareList.includes(country.id) ? (
                ...
                <div className="mb-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {country.topImports.slice(0, 3).map(imp => (
                      <span
                        key={imp}
                        className="text-[9px] bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 px-1.5 py-0.5 rounded"
                      >
                        {imp}
                      </span>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {product.topMarkets.map(m => (
                      <span
                        key={m}
                        className="text-[9px] bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 px-1.5 py-0.5 rounded"
                      >
                        {m}
                      </span>
                    ))}
              ...
              {[
                {
                  ...
                  count: 12,
                  severity: 'Medium',
                  desc: 'Average MFN tariff 15.2% — AfCFTA reducing to 5.1%',
                  color: 'amber',
                },
                {
                  type: 'Non-Tariff',
                  count: 28,
                  severity: 'High',
                  desc: 'SPS measures, import licenses, quotas across ECOWAS',
                  color: 'red',
                },
                {
                  type: 'Regulatory',
                  count: 8,
                  severity: 'Low',
                  desc: 'Documentation requirements, standards conformity',
                  color: 'green',
                },
              ].map(b => (
                <div
                  key={b.type}
                  className={`p-4 rounded-lg border border-${b.color}-200 dark:border-${b.color}-800 bg-${b.color}-50 dark:bg-${b.color}-900/10`}
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded-full bg-${b.color}-100 text-${b.color}-700`}
                    >
                      {b.severity}
                    </span>
                  </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 rounded-xl border border-purple-200 dark:border-purple-800 p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-lg font-bold text-purple-800 dark:text-purple-300">
                AI Market Opportunity Finder
              </h3>
            </div>
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">
              Ask questions like: &ldquo;Top 5 fastest growing markets for maize flour
              exports&rdquo; or &ldquo;Where can I export cassava with lowest tariffs?&rdquo;
            </p>
            <div className="flex gap-2">
              ...
              >
                {aiLoading ? (
                  ...
                  <>
                    <BrainCircuit className="w-4 h-4" /> Find
                  </>
                )}
              </button>
            </div>
            ...
            {[
              {
                ...
                entry: 'Direct Export',
                timeline: '3-6 months',
                keyReq: 'ECOWAS CET compliance',
              },
              {
                market: 'East Africa',
                score: 82,
                entry: 'Distributor Model',
                timeline: '4-8 months',
                keyReq: 'EAC standards cert',
              },
              {
