...
const TENDERS: AnalystTender[] = [
  {
    id: 't1',
    title: 'Supply of Agricultural Inputs — Fertilizer & Seeds',
    ...
    type: 'government',
    summary:
      'Procurement of 50,000MT NPK fertilizer and improved seed varieties for 2025 planting season across 12 counties.',
  },
  {
    id: 't2',
    title: 'Cocoa Bean Procurement — Q2 2025 Batch',
    organization: 'Nestlé West Africa',
    category: 'Agriculture',
    country: 'Ghana',
    budget: '$5.0M–$8.0M',
    deadline: '2025-02-28',
    ...
    type: 'private',
    summary:
      'Bulk procurement of Grade A cocoa beans. Must meet EU quality standards and Fair Trade certification.',
  },
  {
    id: 't3',
    title: 'Port Terminal Equipment Upgrade — Tema Port',
    ...
    type: 'government',
    summary:
      'Supply and installation of 4 STS gantry cranes and RTG equipment for Container Terminal 3 expansion.',
  },
  {
    id: 't4',
    ...
    type: 'government',
    summary:
      'Last-mile distribution of essential medicines and medical supplies across Kenya, Uganda, and Tanzania.',
  },
  {
    id: 't5',
    title: 'Solar Panel Supply for Rural Electrification',
    organization: 'Nigerian Rural Electrification Agency',
    category: 'Energy',
    country: 'Nigeria',
    budget: '$8M–$12M',
    deadline: '2025-02-20',
    ...
    type: 'government',
    summary:
      'Supply of 50MW solar panel systems for off-grid electrification of 200 rural communities.',
  },
  {
    id: 't6',
    title: 'Cotton Yarn Bulk Purchase — Textile Mills',
    organization: 'Thies Textile SA',
    category: 'Textiles',
    country: 'Senegal',
    budget: '$800K–$1.2M',
    deadline: '2025-03-20',
    ...
    type: 'private',
    summary:
      'Annual contract for cotton yarn supply (Ring-spun, 30/1 and 40/1 count). AfCFTA-origin preferred.',
  },
  {
    id: 't7',
    title: 'Road Construction — Trans-Saharan Highway Section',
  ...
  {
    id: 't8',
    title: 'Cement Supply for Housing Development',
    organization: 'Rwanda Housing Authority',
    ...
    type: 'government',
    summary:
      'Supply of 100,000MT Portland cement for national affordable housing program Phase III.',
  },
];
...
const COLLAB_NOTES: CollabNote[] = [
  {
    ...
    content: 'Verified supplier certifications - all requirements met for Kenya tender',
  ...
  },
  {
    ...
    tenderId: 't2',
    author: 'Kwame Asante',
    content: 'Prepare pricing proposal by Feb 25',
  ...
  },
  {
    ...
    content: 'AfCFTA Rules of Origin documentation complete',
    timestamp: '1 day ago',
    type: 'note',
  },
  {
    ...
    tenderId: 't3',
    author: 'David Mwangi',
    content: 'Review financial projections for port equipment bid',
    timestamp: '1 day ago',
    type: 'task',
    completed: true,
  },
  {
    ...
    tenderId: 't2',
    author: 'Sarah Mensah',
    content: 'Contract terms reviewed - recommend negotiation on payment terms',
...
const COLLAB_MESSAGES: CollabMessage[] = [
  {
    ...
    avatar: 'AO',
    content:
      "Team, the Kenya Agriculture tender deadline is approaching. Let's sync on final pricing.",
    timestamp: '10:30 AM',
    tenderId: 't1',
  },
  {
    ...
    author: 'Kwame Asante',
    avatar: 'KA',
    content: "I've updated the bid document with the latest cost estimates. Ready for review.",
    timestamp: '10:45 AM',
    tenderId: 't1',
  },
  {
    ...
    author: 'Fatima Hassan',
    avatar: 'FH',
    content: 'Compliance check complete for Cocoa tender. All certifications verified.',
    timestamp: '11:00 AM',
    tenderId: 't2',
  },
  {
    ...
    author: 'Sarah Mensah',
    avatar: 'SM',
    content: 'Legal review done. Recommend we proceed with the Ghana Ports tender.',
    timestamp: '11:15 AM',
    tenderId: 't3',
  },
];
...
export const AnalystTenderAnalysis: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'feed' | 'analytics' | 'matched' | 'workspace'>(
    'feed'
  );
  ...
  const matchedTenders = TENDERS.filter(t => t.eligibility === 'eligible').sort(
    (a, b) => b.bidProbability - a.bidProbability
  );
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-4">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-trade-primary dark:text-white">
                Tender Analysis
              </h2>
              <p className="text-[10px] text-gray-500">
                Live tender feed • Eligibility checker • Bid probability • AI summaries •
                Collaboration
              </p>
            </div>
          </div>
      ...
      {activeTab === 'feed' && (
        <div className="flex-1 flex flex-col gap-4 overflow-hidden">
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-0 overflow-hidden">
            <div
              className={`${selectedTender ? 'lg:col-span-7' : 'lg:col-span-12'} overflow-y-auto space-y-3`}
            >
              {filtered.map(tender => (
                <div
                  key={tender.id}
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-2">
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        <span
                          className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${
                            tender.type === 'government'
                              ? 'bg-blue-100 text-blue-700'
                              : 'bg-purple-100 text-purple-700'
                          }`}
                        >
                          {tender.type === 'government' ? 'GOV' : 'PRIVATE'}
                        </span>
                        <span
                          className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${
                            tender.status === 'open'
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-sm font-black text-trade-primary dark:text-white">
                        {tender.budget}
                      </p>
                      <div className="flex items-center gap-1 justify-end mt-1">
                        <Clock className="w-3 h-3 text-gray-400" />
                        <span
                          className={`text-[10px] font-bold ${tender.daysLeft <= 7 ? 'text-red-600' : tender.daysLeft <= 14 ? 'text-amber-600' : 'text-gray-500'}`}
                        >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 text-[10px] text-gray-400">
                      ...
                      <span className="flex items-center gap-0.5">
                        <Users className="w-3 h-3" /> {tender.bids} bids
                      </span>
                      <span className="flex items-center gap-0.5">
                        <Eye className="w-3 h-3" /> {tender.views}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-[10px] font-black px-2 py-0.5 rounded-full ${
                          tender.bidProbability >= 70
                            ? 'bg-green-50 text-green-700'
                            : tender.bidProbability >= 40
              ...
              <div className="lg:col-span-5 bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 overflow-y-auto p-5">
                <div className="flex items-center justify-between mb-4">
                  <span
                    className={`text-[10px] font-bold px-2 py-1 rounded-lg ${
                      selectedTender.type === 'government'
                        ? 'bg-blue-100 text-blue-700'
                        : 'bg-purple-100 text-purple-700'
                    }`}
                  >
                    {selectedTender.type === 'government' ? 'Government Tender' : 'Private RFQ'}
                  </span>
                  <button
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                    ...
                    <p
                      className={`text-[9px] font-bold ${selectedTender.daysLeft <= 7 ? 'text-red-600' : 'text-gray-400'}`}
                    >
                      {selectedTender.daysLeft} days remaining
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                    ...
                    <p
                      className={`text-lg font-black ${
                        selectedTender.bidProbability >= 70
                          ? 'text-green-600'
                          : selectedTender.bidProbability >= 40
                            ? 'text-amber-600'
                            : 'text-red-600'
                      }`}
                    >
                      {selectedTender.bidProbability}%
                    </p>
                  </div>
                  <div className="bg-gray-50 dark:bg-slate-700/50 rounded-lg p-3">
                ...
                <div className="mb-4">
                  ...
                  <div
                    className={`p-3 rounded-lg border ${
                      selectedTender.eligibility === 'eligible'
                        ? 'bg-green-50 border-green-200 dark:bg-green-900/10 dark:border-green-800'
                        : selectedTender.eligibility === 'partial'
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {selectedTender.eligibility === 'eligible'
                          ? 'Fully Eligible — Meets all requirements'
                          : selectedTender.eligibility === 'partial'
                            ? 'Partially Eligible — Some requirements need review'
        ...
        <div className="flex-1 flex flex-col gap-4 overflow-y-auto">
          <div className="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-900/10 dark:to-pink-900/10 rounded-xl border border-rose-200 dark:border-rose-800 p-4">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              Tenders automatically matched to your profile, sector, and capabilities. Ranked by win
              probability.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {matchedTenders.map((t, i) => (
              <div
                key={t.id}
                className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-4 flex items-center gap-4"
              >
                <div
                ...
                <div className="text-right shrink-0">
                  ...
                  <p
                    className={`text-xs font-black ${t.bidProbability >= 70 ? 'text-green-600' : 'text-amber-600'}`}
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5 flex-1">
              ...
              <div className="space-y-2">
                {TENDERS.filter(t => t.eligibility === 'eligible')
                  .sort((a, b) => b.bidProbability - a.bidProbability)
                  .slice(0, 4)
                  .map(t => (
                    <div
                      key={t.id}
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-4">
              ...
              <div className="space-y-2">
                {TEAM_MEMBERS.map(member => (
                  <div
                    key={member.id}
                    className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors"
                  >
              ...
              {workspaceTab === 'notes' && (
                <div className="flex-1 flex flex-col">
                  <div className="flex-1 space-y-2 overflow-y-auto mb-3">
                    {notes
                      .filter(n => n.type === 'note' || n.type === 'comment')
                      .map(note => (
                        <div
                          key={note.id}
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p
                              className={`text-xs font-medium ${task.completed ? 'text-gray-400 line-through' : 'text-gray-800 dark:text-white'}`}
                            >
                              {task.content}
                            </p>
