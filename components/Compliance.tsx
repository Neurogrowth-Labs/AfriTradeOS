...
const COMPLIANCE_RISKS = [
  {
    ...
    status: 'compliant',
    score: 92,
    details: 'AfCFTA certificate valid until Dec 2026',
  },
  {
    id: 'r2',
    area: 'Import Licensing',
    status: 'warning',
    score: 65,
    details: 'Import permit renewal due in 30 days',
  },
  {
    id: 'r3',
    area: 'Customs Documentation',
    status: 'compliant',
    score: 88,
    details: 'All import declarations up to date',
  },
  {
    id: 'r4',
    ...
    status: 'compliant',
    score: 100,
    details: 'No matches found in latest screening',
  },
  {
    id: 'r5',
    area: 'Import VAT & Duties',
    status: 'critical',
    score: 35,
    details: 'VAT registration pending for Nigeria imports',
  },
  {
    id: 'r6',
    ...
    status: 'warning',
    score: 70,
    details: 'Conformity certificate expiring in 60 days',
  },
  {
    id: 'r7',
    area: 'Tariff Classification',
    status: 'compliant',
    score: 95,
    details: 'HS codes verified for AfCFTA preferential rates',
  },
  {
    id: 'r8',
    area: 'Pre-Shipment Inspection',
    status: 'warning',
    score: 72,
    details: 'PVoC inspection required for next shipment',
  },
];
...
const CROSS_BORDER_GUIDES = [
  {
    id: 'g1',
    title: 'Exporting to Nigeria',
    country: 'Nigeria',
    steps: [
      {
        step: 1,
        title: 'Obtain Export License',
        description: "Apply through your country's trade ministry. Processing: 5-10 business days.",
        required: true,
      },
      {
        step: 2,
        title: 'Product Certification',
        description: 'Obtain SON (Standards Organisation of Nigeria) conformity certificate.',
        required: true,
      },
      {
        step: 3,
        title: 'AfCFTA Certificate of Origin',
        description: 'Apply via customs portal with proof of local content ≥40%.',
        required: true,
      },
      {
        step: 4,
        title: 'Customs Declaration',
        description: 'Complete NCS Single Window declaration form. Include HS codes.',
        required: true,
      },
      {
        step: 5,
        title: 'Payment of Duties',
        description: 'Pay applicable tariffs (reduced under AfCFTA). Ensure FOREX compliance.',
        required: true,
      },
    ],
  },
  {
    id: 'g2',
    title: 'Exporting to Kenya',
    country: 'Kenya',
    steps: [
      {
        step: 1,
        title: 'Register with KRA',
        description: 'Register as an importer/exporter with Kenya Revenue Authority.',
        required: true,
      },
      {
        step: 2,
        title: 'KEBS Standards Mark',
        description: 'Obtain Kenya Bureau of Standards certification for your product.',
        required: true,
      },
      {
        step: 3,
        title: 'Pre-Shipment Inspection',
        description: 'Arrange PVoC (Pre-Export Verification of Conformity) inspection.',
        required: true,
      },
      {
        step: 4,
        title: 'IDF Application',
        description: 'Apply for Import Declaration Form through KRA iTax portal.',
        required: true,
      },
    ],
  },
  {
    id: 'g3',
    title: 'Exporting to South Africa',
    country: 'South Africa',
    steps: [
      {
        step: 1,
        title: 'SARS Registration',
        description: 'Register with South African Revenue Service for customs.',
        required: true,
      },
      {
        step: 2,
        title: 'NRCS Compliance',
        description: 'Ensure product meets National Regulator for Compulsory Specifications.',
        required: true,
      },
      {
        step: 3,
        title: 'Letter of Authority',
        description: 'Obtain import permit from ITAC if product requires one.',
        required: false,
      },
      {
        step: 4,
        title: 'Customs Clearance',
        description: 'Submit SAD500 form through customs broker. Pay duties via eFiling.',
        required: true,
      },
    ],
  },
  {
    id: 'g4',
    title: 'Importing from Ghana',
    country: 'Ghana',
    steps: [
      {
        step: 1,
        title: 'Verify AfCFTA Eligibility',
        description:
          'Confirm product qualifies for AfCFTA preferential tariff rates with Certificate of Origin.',
        required: true,
      },
      {
        step: 2,
        title: 'Import Permit Application',
        description: "Apply for import permit through your country's trade regulatory body.",
        required: true,
      },
      {
        step: 3,
        title: 'Pre-Arrival Declaration',
        description: 'Submit advance customs declaration at least 48h before shipment arrival.',
        required: true,
      },
      {
        step: 4,
        ...
        description:
          'Calculate applicable AfCFTA reduced duties and local VAT. Use tariff calculator.',
        required: true,
      },
      {
        step: 5,
        title: 'Customs Inspection',
        description: 'Schedule inspection at port of entry. Prepare all supporting documents.',
        required: true,
      },
    ],
  },
  {
    id: 'g5',
    title: 'Importing from Egypt',
    country: 'Egypt',
    steps: [
      {
        step: 1,
        title: 'Verify Certificate of Origin',
        description: 'Ensure supplier provides valid AfCFTA or bilateral trade certificate.',
        required: true,
      },
      {
        step: 2,
        title: 'Quality & Standards Check',
        description: "Verify product meets destination country's standards (KEBS, SON, SABS).",
        required: true,
      },
      {
        step: 3,
        title: 'Import Declaration Filing',
        description: "File import declaration through your country's Single Window system.",
        required: true,
      },
      {
        step: 4,
        title: 'Payment & Clearance',
        description: 'Pay applicable duties (check AfCFTA reductions) and clear goods at port.',
        required: true,
      },
    ],
  },
...
export const Compliance: React.FC = () => {
  const [activeView, setActiveView] = useState<'simulator' | 'dashboard' | 'guides' | 'checklist'>(
    'simulator'
  );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                AfCFTA regulatory guidelines, AI compliance checker & policy change alerts
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5 text-center">
              <div className="relative w-20 h-20 mx-auto mb-2">
                ...
                <span className="absolute inset-0 flex items-center justify-center text-xl font-bold text-trade-primary dark:text-white">
                  75%
                </span>
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5">
              <div className="grid grid-cols-3 gap-3 h-full">
                {[
                  {
                    label: 'Compliant',
                    count: COMPLIANCE_RISKS.filter(r => r.status === 'compliant').length,
                    color: 'text-green-600 bg-green-100',
                  },
                  {
                    label: 'Warning',
                    count: COMPLIANCE_RISKS.filter(r => r.status === 'warning').length,
                    color: 'text-amber-600 bg-amber-100',
                  },
                  {
                    label: 'Critical',
                    count: COMPLIANCE_RISKS.filter(r => r.status === 'critical').length,
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 p-5 flex flex-col justify-center">
              ...
              <p className="text-sm font-bold text-trade-primary dark:text-white flex items-center gap-1">
                <Clock className="w-3.5 h-3.5" /> Feb 8, 2026
              </p>
              <p className="text-xs text-gray-500 mt-2 mb-1">Next Review</p>
              <p className="text-sm font-bold text-trade-primary dark:text-white flex items-center gap-1">
                <Clock className="w-3.5 h-3.5" /> Mar 1, 2026
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {COMPLIANCE_RISKS.map(risk => (
              <div
                key={risk.id}
                className={`bg-white dark:bg-slate-800 rounded-xl border p-5 flex items-center justify-between ${
          ...
          <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-900/30 rounded-xl p-4 flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-xs font-bold text-amber-800 dark:text-amber-300">
                Regulatory Update — Nigeria
              </p>
              <p className="text-[10px] text-amber-700 dark:text-amber-400 mt-0.5">
                New SON conformity assessment requirement effective March 2026. Products in HS
                Chapter 84-85 now require additional certification.
              </p>
              <button
          ...
          <div className="bg-gradient-to-r from-trade-primary to-trade-secondary rounded-xl p-4 text-white flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium">
                AI Compliance Assistant: You have <span className="font-bold">3 items</span>{' '}
                requiring action. Complete them to maintain your compliance score above 80%.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                description: 'AfCFTA Certificate of Origin filed and verified',
                deadline: 'Completed Feb 1',
              },
              {
                id: 'ck2',
                ...
                description: 'Import permit expires in 30 days — renewal required',
                deadline: 'Due Mar 15',
              },
              {
                id: 'ck3',
                title: 'VAT Registration (Nigeria)',
                category: 'Duties',
                status: 'critical' as const,
                description: 'VAT registration pending for Nigeria import operations',
                deadline: 'Overdue',
              },
              {
                id: 'ck4',
                title: 'Product Standards (KEBS)',
                category: 'Standards',
                status: 'pending' as const,
                description: 'Kenya Bureau of Standards certification for electronics',
                deadline: 'Due Apr 1',
              },
              {
                id: 'ck5',
                ...
                category: 'Compliance',
                status: 'complete' as const,
                description: 'Latest screening completed — no matches found',
              ...
              },
              {
                ...
                category: 'Customs',
                status: 'pending' as const,
                description: 'PVoC inspection required for next Kenya-bound shipment',
                deadline: 'Due Mar 20',
              },
              {
                id: 'ck7',
                title: 'Customs Bond Renewal',
                category: 'Customs',
                status: 'complete' as const,
                description: 'Customs bond guarantee renewed for 2026',
                deadline: 'Completed Jan 15',
              },
              {
                id: 'ck8',
                title: 'AfCFTA Tariff Classification',
                category: 'Duties',
                status: 'complete' as const,
                description: 'HS codes verified for preferential tariff rates',
                deadline: 'Completed Feb 5',
              },
            ].map(item => (
              <div
                key={item.id}
                className={`bg-white dark:bg-slate-800 rounded-xl border p-4 flex items-center gap-4 transition-all hover:shadow-sm ${
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div className="bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-200 dark:border-blue-900/30 p-4 flex items-center gap-3">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-300">
              Step-by-step compliance guides for exporting to key African markets under AfCFTA.
            </p>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-500">
                      {guide.steps.length} steps • {guide.steps.filter(s => s.required).length}{' '}
                      required
                    </p>
                  </div>
                </div>
                <ChevronDown
                  className={`w-5 h-5 text-gray-400 transition-transform ${expandedGuide === guide.id ? 'rotate-180' : ''}`}
                />
              </button>
                    ...
                    <div key={idx} className="flex gap-4">
                      ...
                      <div className="flex-1 pb-4">
                        <div className="flex items-center gap-2">
                          ...
                          {step.required && (
                            <span className="text-[9px] font-bold px-1.5 py-0.5 bg-red-100 text-red-600 rounded">
                              REQUIRED
                            </span>
                          )}
                        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 min-h-0">
          ...
          <div className="lg:col-span-3 flex flex-col gap-5">
            ...
            <div
              className={`p-5 rounded-2xl border flex flex-col items-center justify-center text-center transition-all ${
                loading
                  ...
                  : score > 0
                    ? score >= 60
                      ? 'bg-green-50/50 border-trade-success/30'
                      : 'bg-red-50/50 border-trade-error/30'
                    : 'bg-white dark:bg-slate-800 border-gray-100 dark:border-slate-700'
              }`}
            >
              <h3 className="text-[10px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-3 font-heading">
                Compliance Score
              </h3>
              <div className="relative w-28 h-28 flex items-center justify-center mb-2">
                ...
                <span className="absolute text-3xl font-black font-mono text-trade-primary dark:text-white">
                  {loading ? (
                    <Loader2 className="animate-spin w-6 h-6 text-trade-secondary" />
                  ) : (
                    score
                  )}
                </span>
              ...
              <span
                className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${
                  loading
                    ...
                    : score >= 60
                      ? 'bg-green-100 text-trade-success'
                      : score > 0
                        ? 'bg-red-100 text-trade-error'
                        : 'bg-gray-100 text-gray-400'
                }`}
              >
                {loading
            ...
            <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm flex-1">
              <h3 className="font-bold text-trade-primary dark:text-white mb-3 font-heading text-sm">
                Trade Parameters
              </h3>
              <div className="space-y-3">
                <div>
            ...
            <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm h-full overflow-y-auto">
              ...
              <div className="space-y-5">
                <div className="flex gap-3">
                  <div
                    className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${score > 0 ? 'bg-green-100 text-trade-success' : 'bg-gray-100 text-gray-400'}`}
                  >
                    {score > 0 ? (
                  ...
                  <div>
                    <h4 className="font-bold text-trade-primary dark:text-white text-xs">
                      Wholly Obtained Status
                    </h4>
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      Product must be grown, harvested, or extracted entirely within the member
                      state.
                    </p>
                ...
                <div className="flex gap-3">
                  <div
                    className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${score > 0 && score < 60 ? 'bg-red-100 text-trade-error' : score >= 60 ? 'bg-green-100 text-trade-success' : 'bg-gray-100 text-gray-400'}`}
                  >
                    {score > 0 && score < 60 ? (
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      Non-originating materials must not exceed 60% of ex-works price.
                    </p>
                    {score > 0 && (
                      <div
                        className={`mt-1 text-[10px] font-medium px-2 py-0.5 rounded w-fit font-mono ${score >= 60 ? 'text-trade-success bg-green-50' : 'text-trade-error bg-red-50'}`}
                      >
                        {score >= 60
                          ? 'PASSED: 60% Local Content'
                          : 'FAILED: High non-originating content'}
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 mt-0.5">
                      Final product HS code must differ from non-originating input codes.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-trade-primary to-trade-secondary dark:from-slate-800 dark:to-slate-800 p-5 rounded-xl border border-trade-primary/50 dark:border-slate-700 shadow-sm h-full flex flex-col text-white">
                ...
                {loading ? (
                  ...
                  <div className="prose prose-sm prose-invert max-w-none">
                    ...
                    <div className="mt-4 pt-3 border-t border-white/10">
                      <h4 className="text-[10px] font-bold text-trade-accent uppercase mb-1">
                        Recommended Actions
                      </h4>
              ...
              <div className="mt-3 p-2.5 bg-trade-accent/20 rounded-lg flex items-start gap-2 border border-trade-accent/30">
                ...
                <p className="text-[10px] text-trade-accent leading-tight">
                  <strong>AI Strategic Insight:</strong> Changing your sourcing country could reduce
                  tariffs by 6% when exporting to {dest}.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <h4 className="font-bold text-gray-900 dark:text-white">
                New SON Conformity Assessment Requirement — Nigeria
              </h4>

              <div className="prose prose-sm dark:prose-invert">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  The Standards Organisation of Nigeria (SON) has issued new conformity assessment
                  requirements for products falling under HS Chapters 84-85 (Machinery and
                  Electrical Equipment).
                </p>

                <div className="mt-4 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
                  <h5 className="text-sm font-bold text-gray-800 dark:text-white mb-2">
                    Key Changes:
                  </h5>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
                  For more information, contact SON directly or consult with your customs broker.
                  AfriTradeOS will automatically update compliance checklists for affected products.
                </p>
              </div>
