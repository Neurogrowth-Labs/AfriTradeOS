...
const ROUTE_RISKS: RouteRisk[] = [
  {
    ...
    type: 'port',
    risk: 'high',
    location: { x: 320, y: 350 },
    detail: 'Congestion & container backlog, avg 72h wait',
    avgDelay: '+72h',
  },
  {
    id: 'rr2',
    ...
    detail: 'Efficient operations, automated gates',
    avgDelay: '+4h',
  },
  {
    id: 'rr3',
    ...
    type: 'port',
    risk: 'medium',
    location: { x: 600, y: 470 },
    detail: 'Moderate congestion, customs digitized',
    avgDelay: '+24h',
  },
  {
    id: 'rr4',
    name: 'Cotonou Customs',
    type: 'customs',
    risk: 'critical',
    location: { x: 330, y: 340 },
    detail: 'Manual inspections, high corruption index',
    avgDelay: '+96h',
  },
  {
    id: 'rr5',
    name: 'Kenya-Uganda Border',
    type: 'customs',
    risk: 'medium',
    location: { x: 580, y: 430 },
    detail: 'OSBP operational but periodic delays',
    avgDelay: '+12h',
  },
  {
    id: 'rr6',
    name: 'Trans-Sahara Route',
    type: 'route',
    risk: 'high',
    location: { x: 380, y: 200 },
    detail: 'Poor road infrastructure, security risks',
    avgDelay: '+48h',
  },
  {
    id: 'rr7',
    ...
    type: 'port',
    risk: 'low',
    location: { x: 520, y: 720 },
    detail: 'Modern deep-water port, quick turnaround',
    avgDelay: '+8h',
  },
  {
    id: 'rr8',
    ...
    type: 'route',
    risk: 'medium',
    location: { x: 560, y: 450 },
    detail: 'Mombasa-Nairobi-Kampala, improving',
    avgDelay: '+18h',
  },
];
...
const MOCK_ETA_TIMELINE: ETAEntry[] = [
  {
    id: 'eta1',
    shipmentId: 'SH-001',
    milestone: 'Export – Cargo Pickup',
    planned: 'Jan 15, 08:00',
    actual: 'Jan 15, 08:30',
    status: 'completed',
    delayHours: 0.5,
  },
  {
    id: 'eta2',
    shipmentId: 'SH-001',
    milestone: 'Export – Port of Origin',
    planned: 'Jan 16, 14:00',
    actual: 'Jan 16, 16:00',
    status: 'completed',
    delayHours: 2,
  },
  {
    id: 'eta3',
    shipmentId: 'SH-001',
    milestone: 'In Transit – Customs Clearance',
    planned: 'Jan 17, 10:00',
    actual: 'Jan 18, 14:00',
    status: 'delayed',
    delayHours: 28,
  },
  {
    id: 'eta4',
    shipmentId: 'SH-001',
    milestone: 'In Transit – Vessel Departure',
    planned: 'Jan 19, 06:00',
    status: 'on_time',
  },
  {
    id: 'eta5',
    shipmentId: 'SH-001',
    milestone: 'Import – Port of Destination',
    planned: 'Jan 25, 12:00',
    status: 'upcoming',
  },
  {
    id: 'eta6',
    shipmentId: 'SH-001',
    milestone: 'Delivery – Last Mile',
    planned: 'Jan 27, 09:00',
    status: 'upcoming',
  },
];
...
export const Logistics: React.FC = () => {
  const [activeTab, setActiveTab] = useState<
    'tracking' | 'booking' | 'route_map' | 'risk_levels' | 'eta_timeline'
  >('tracking');
        ...
        if (supabaseShipments.length > 0) {
          ...
          const shipments: Shipment[] = supabaseShipments.map((s: ShipmentTracking) => {
            ...
            return {
              ...
              mode:
                s.transport_mode === 'sea' ? 'Sea' : s.transport_mode === 'air' ? 'Air' : 'Road',
              carrier: s.carrier_name || 'Pending Assignment',
              timeline:
                s.timeline && Array.isArray(s.timeline)
                  ? s.timeline.map((t: { date: string; event: string; location: string }) => ({
                      location: t.location || '',
                      date: t.date || '',
                      status: 'completed',
                      label: t.event || '',
                  ...
                  : [
                      {
                        location: s.origin_port || 'Origin',
                        date: s.departure_date || 'Pending',
                        status: 'completed',
                        label: 'Departed',
                      },
                      {
                        location: s.current_location || 'In Transit',
                        date: 'Current',
                        status: 'active',
                        label: 'In Transit',
                      },
                      {
                        location: s.destination_port || 'Destination',
                        date: s.eta || 'Est.',
                        status: 'pending',
                        label: 'Arrival',
                      },
          ...
          const shipments: Shipment[] = trades
            ...
            .map(t => ({
              ...
              timeline: [
                {
                  location: t.origin_country || 'Origin',
                ...
                {
                  location: t.destination_country || 'Destination',
                  date: 'Est.',
                  status: 'pending',
                  label: 'Delivery',
                },
  ...
  const [quoteRequests, setQuoteRequests] = useState<
    Record<string, 'pending' | 'sent' | 'received'>
  >({});
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Real-time GPS tracking, multi-leg visualization & AI ETA predictions
            </p>
          </div>
        </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-900/30 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-amber-700 dark:text-amber-400 mt-0.5">
                  Port congestion at Lagos — expect +24h delay on shipments via Apapa terminal.
                </p>
            ...
            <div className="bg-teal-50 dark:bg-teal-900/10 border border-teal-200 dark:border-teal-900/30 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-teal-700 dark:text-teal-400 mt-0.5">
                  Switch to Tema Port (Ghana) via AfCFTA free trade zone — save{' '}
                  <span className="font-bold">$1,200</span> and{' '}
                  <span className="font-bold">2 days</span> transit time.
                </p>
                <button
            ...
            <div className="bg-indigo-50 dark:bg-indigo-900/10 border border-indigo-200 dark:border-indigo-900/30 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-indigo-700 dark:text-indigo-400 mt-0.5">
                  Pre-filled customs forms ready for {liveShipments.length} shipment
                  {liveShipments.length > 1 ? 's' : ''}. QR codes generated for faster border
                  processing.
                </p>
                <div className="flex gap-2 mt-2">
                  <button
              ...
              <>
                  ...
                  <div className="flex justify-between items-start mb-8 relative z-10">
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                        {selectedShipment.origin} <span className="text-gray-300">→</span>{' '}
                        {selectedShipment.destination}
                      </h2>
                      <p className="text-sm text-gray-500 mt-1">
                        Via {selectedShipment.mode} Freight • Carrier: {selectedShipment.carrier}
                      </p>
                    </div>
                    <div className="text-right">
                            ...
                            className={`w-8 h-8 rounded-full flex items-center justify-center border-4 ${
                              event.status === 'completed'
                                ...
                                : event.status === 'delayed'
                                  ? 'bg-red-500 border-red-100 dark:border-red-900 text-white'
                                  : event.status === 'active'
                                    ? 'bg-white border-teal-500 text-teal-500 animate-pulse'
                ...
                {selectedShipment.status === 'at_risk' || selectedShipment.status === 'delayed' ? (
                  <div className="bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-xl p-6 flex flex-col md:flex-row gap-6 animate-fade-in">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-red-700 dark:text-red-300 mb-4">
                        Shipment is held at Cotonou border control due to missing Certificate of
                        Conformity. Delay impact: +48h.
                      </p>
                      <div className="flex gap-3">
                        <button
                          onClick={() => handleAction('Agent Contact')}
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-white dark:bg-slate-800 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 text-sm font-bold rounded-lg transition-colors"
                        >
                          Upload Documents
                        </button>
                      </div>
                  ...
                  <div className="bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-900/30 rounded-xl p-6 flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-emerald-800 dark:text-emerald-400 font-bold">
                        Shipment On Track
                      </h4>
                      <p className="text-sm text-emerald-700 dark:text-emerald-300">
                        All milestones completed on schedule. No exceptions detected.
                      </p>
                    </div>
                  </div>
                )}
        ...
        <div className="flex-1 flex flex-col gap-6 overflow-y-auto">
          <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm text-center">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
              Find & Compare Logistics Providers
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {PROVIDERS.map((provider, i) => (
              <div
                key={i}
                className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all relative overflow-hidden group"
              >
                <div
                  ...
                  {result.maps.map((source, idx) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        {source.address && (
                          <p className="text-xs text-gray-500 line-clamp-1">{source.address}</p>
                        )}
                      </div>
                    </a>
                  ))}
        ...
        >
          ...
          <div className="absolute top-4 right-4 z-10 flex flex-col gap-1.5">
            <button
              ...
              className="p-2 bg-slate-800/90 backdrop-blur hover:bg-slate-700 rounded-lg border border-slate-700 text-slate-300 hover:text-white transition-colors"
              title="Zoom In"
            >
          ...
          >
            ...
            {liveShipments.map((s, i) => {
              ...
              return (
                <g key={s.id}>
                  ...
                  {/* Labels */}
                  <text x={x1 - 10} y={y1 - 10} fill="#94a3b8" fontSize="9" textAnchor="end">
                    {s.origin}
                  </text>
                  <text x={x2 + 10} y={y2 + 15} fill="#94a3b8" fontSize="9">
                    {s.destination}
                  </text>
                </g>
              );
            ...
            {ROUTE_RISKS.map(rr => {
              ...
              return (
                <g
                  key={rr.id}
                  onClick={() => setSelectedRisk(selectedRisk?.id === rr.id ? null : rr)}
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${
                        selectedRisk.risk === 'low'
                          ? 'bg-green-100 text-green-700'
                          : selectedRisk.risk === 'medium'
      ...
      {activeTab === 'risk_levels' && (
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {ROUTE_RISKS.filter(rr => riskFilter === 'all' || rr.type === riskFilter).map(rr => {
              const riskConfig = {
                low: {
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${cfg.badge}`}
                      >
                        {rr.risk}
                      </span>
                    </div>
                    <span className="text-[10px] text-gray-500 capitalize bg-white dark:bg-slate-800 px-2 py-0.5 rounded">
                      {rr.type}
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-4 gap-4 text-center">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {ROUTE_RISKS.filter(r => r.risk === 'low').length}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Medium</p>
                <p className="text-2xl font-bold text-amber-600">
                  {ROUTE_RISKS.filter(r => r.risk === 'medium').length}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500">High</p>
                <p className="text-2xl font-bold text-red-600">
                  {ROUTE_RISKS.filter(r => r.risk === 'high').length}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Critical</p>
                <p className="text-2xl font-bold text-red-900">
                  {ROUTE_RISKS.filter(r => r.risk === 'critical').length}
                </p>
              </div>
            </div>
          </div>
                ...
                {MOCK_ETA_TIMELINE.map((entry, idx) => {
                  ...
                  return (
                    <div key={entry.id} className="relative flex items-start gap-4 mb-6 last:mb-0">
                      {/* Dot */}
                      <div
                        className={`relative z-10 w-3 h-3 rounded-full ${cfg.bg} ring-4 ${cfg.ring} mt-1.5 ml-[18px]`}
                      />
                          ...
                          <div className="grid grid-cols-2 gap-4 text-xs">
                            ...
                            {entry.actual && (
                              <div>
                                ...
                                <p
                                  className={`font-medium ${entry.status === 'delayed' ? 'text-red-600' : 'text-gray-700 dark:text-gray-300'}`}
                                >
                                  {entry.actual}
                                </p>
                              </div>
            ...
            <div className="relative z-10 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs opacity-90">
                  Based on current customs processing times, weather conditions, and port congestion
                  at destination, we estimate a <span className="font-bold">+30h total delay</span>{' '}
                  from original schedule. Consider notifying your supplier about adjusted delivery
                  windows.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-3 bg-green-50 dark:bg-green-900/10 rounded-lg">
                ...
                <p className="text-xl font-bold text-green-600">
                  {
                    MOCK_ETA_TIMELINE.filter(
                      e => e.status === 'completed' || e.status === 'on_time'
                    ).length
                  }
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-800 dark:text-amber-400">
                      High congestion at Apapa terminal due to container backlog. Average processing
                      time increased from 48h to 72h.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6 border-b border-gray-100 dark:border-slate-700">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Scan at customs checkpoints for faster processing
                  </p>
                </div>
                <button
