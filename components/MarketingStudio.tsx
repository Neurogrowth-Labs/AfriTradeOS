        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Generate professional product shots with Gemini 3 Pro
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              prompt:
                'Professional product brochure layout for African export goods, clean design with product images and specifications',
            },
            {
              ...
              prompt:
                'Vibrant social media post showcasing African products, modern design with bold colors and engaging visuals',
            },
            {
              ...
              prompt:
                'Product catalog page with multiple items, grid layout, professional photography style',
            },
            {
              name: 'Email Campaign',
              icon: Mail,
              ...
              prompt:
                'Email newsletter header image for African trade products, professional and inviting',
            },
          ].map(tpl => (
            <button
              key={tpl.name}
            ...
            >
              <div
                className={`p-2.5 rounded-lg ${tpl.color} w-fit mb-3 group-hover:scale-110 transition-transform`}
              >
        ...
        <div className="bg-gradient-to-br from-pink-500 to-purple-600 p-6 rounded-xl text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm opacity-90 mb-4">
              Based on your target markets in West Africa, here are content ideas:
            </p>
            <div className="space-y-2">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-start gap-2 bg-white/10 rounded-lg p-2.5 backdrop-blur-sm"
                >
            ...
            <div className="p-6 space-y-6 overflow-y-auto max-h-[60vh]">
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="w-6 h-6 bg-pink-100 dark:bg-pink-900/30 rounded-full flex items-center justify-center text-xs font-bold text-pink-600">
                          {idx + 1}
                        </span>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {['Nigeria (34%)', 'Kenya (22%)', 'Ghana (18%)', 'South Africa (15%)'].map(
                      market => (
                        <div key={market} className="text-sm text-gray-600 dark:text-gray-400">
                          {market}
                        </div>
                      )
                    )}
                ...
                <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={type} className="text-sm text-gray-600 dark:text-gray-400">
                        {type}
                      </div>
                    ))}
                  </div>
